...
ActiveRecord::Schema.define(version: 20160715044511) do
  ...
  add_index "drug_movements", ["movable_type", "movable_id"], name: "index_drug_movements_on_movable_type_and_movable_id"
